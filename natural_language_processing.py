...
CM_naiveBayesCM = confusion_matrix(y_test, naiveBayesy_pred)
...
CM_logisticRegressionCM = confusion_matrix(y_test, logisticRegressiony_pred)
...
CM_KNeighborsCM = confusion_matrix(y_test, KNNeighborsy_pred)
...
CM_SVCM = confusion_matrix(y_test, SVy_pred)
...
CM_KSVCM = confusion_matrix(y_test, KSVy_pred)
...
CM_DTCM = confusion_matrix(y_test, DTy_pred)
...
CM_RFCM = confusion_matrix(y_test, RFy_pred)
